...
const MainContent = () => {
  return (
    <section className='flex flex-col h-screen items-center justify-center text-[#333333] font-montserrat pl-12'>
        <h1 className="font-bold text-lg w-[280px] text-center">Start a new resume with Us</h1>
        <h3 className='text-sm font-medium relative top-2'>Build a new resume with us</h3>
        <div className="flex flex-col items-center justify-center xl:flex-row lg:flex-row md:flex-row">
            <Link to={'/create-new-resume'} className="flex flex-col items-center mt-10 cursor-pointer">
                <div className="w-[50mm] h-[57mm] bg-white shadow-lg border border-[#ccc] flex items-center justify-center">
